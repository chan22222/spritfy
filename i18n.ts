...
export const i18n: Record<Lang, Record<string, string>> = {
  ...
  en: {
    ...
    // SEO
    seoLandingTitle: '스프릿파이(Spritfy) - Free Pixel Art Editor & Sprite Sheet Generator & Image Converter',
    seoLandingDesc: '스프릿파이 - Free online pixel art editor, sprite sheet generator, and video/GIF to sprite sheet converter. Create pixel art and convert videos to sprite sheets right in your browser.',
    seoEditorTitle: 'Pixel Art Editor - 스프릿파이(Spritfy) | Free Online Dot Art Tool',
    ...
    seoSpriteTitle: 'Sprite Sheet Generator - 스프릿파이(Spritfy) | Video/GIF to Sheet',
    ...
    seoConverterTitle: 'Image Format Converter - 스프릿파이(Spritfy) | PNG, JPG, WebP, ICO',
    ...
    seoAboutTitle: 'About - 스프릿파이(Spritfy)',
    seoAboutDesc: 'About 스프릿파이(Spritfy). A free online pixel art editor, sprite sheet generator, and image format converter.',
    seoPrivacyTitle: 'Privacy Policy - 스프릿파이(Spritfy)',
    seoPrivacyDesc: 'Spritfy Privacy Policy.',
    seoTermsTitle: 'Terms of Service - 스프릿파이(Spritfy)',
    seoTermsDesc: 'Spritfy Terms of Service.',
    seoGuideSpriteTitle: 'Sprite Sheet Guide - 스프릿파이(Spritfy) | How to Make Sprite Sheets',
    ...
    seoGuidePixelTitle: 'Pixel Art Guide - 스프릿파이(Spritfy) | How to Draw Pixel Art',
